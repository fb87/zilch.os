...
CONFIG_TRACE := $(CONFIG_VERBOSE_DIAGNOSTICS)
...
SRCTREE := $(CURDIR)
OBJTREE := $(abspath $(O))
export SRCTREE OBJTREE ARCH PLATFORM BUILD_VARIANT CONFIG_SELFTEST CONFIG_HYPERVISOR_SELFTEST CONFIG_VERBOSE_DIAGNOSTICS CONFIG_TRACE
