...
| SEC-004 | IN PROGRESS | `arch/arm64/kernel.ld`, `arch/arm64/boot/start.S` | Repeated clean four-CPU certification runs pass with disjoint 32 KiB EL1/EL2 stacks | Guard pages and measured stack high-water enforcement remain open |
