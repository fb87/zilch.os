...
| SEC-004 | IN PROGRESS | `arch/arm64/kernel.ld`, `arch/arm64/boot/start.S`, `arch/arm64/include/sys/arch/stack.hh`, `arch/arm64/arch.cc` | Clean four-CPU certification validates stack bounds/canaries on every exception and retains EL1/EL2 low-water marks | Unmapped guard pages remain open |
