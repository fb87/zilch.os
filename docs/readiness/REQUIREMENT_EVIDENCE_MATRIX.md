...
| IPC-017/018/020 | COMPLETE | `docs/readiness/FAULT_IPC_PROTOCOL.md` | scheduler exception classification, public fault ABI, userspace pager policy | two real data-fault resumes plus real PL3 `udf` termination; `userspace_pager_service` and full acceptance pass | Cross-architecture metadata contract remains IPC-019 |
