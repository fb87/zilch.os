...
- `docs/readiness/PRODUCTION_READINESS_CHECKLIST.md`: authoritative requirement tracker.
- `docs/architecture/alignment/ARCHITECTURE_ALIGNMENT_REVIEW.md`: imported architectural review.
- `docs/roadmap/PROGRAM_CHECKLIST.md`: concise index, current blockers, and execution order.
