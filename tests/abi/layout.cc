...
static_assert(sizeof(vm_exit_result) == sizeof(word_t) * 6U);
static_assert(offsetof(vm_exit_result, qualification) == sizeof(word_t) * 5U);
static_assert(std::is_standard_layout_v<vm_exit_result>);
static_assert(std::is_trivially_copyable_v<vm_exit_result>);
